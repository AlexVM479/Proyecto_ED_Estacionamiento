...
public class LogIn extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel2.add(login_title, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 120, 80, 30));
    ...
    String usuario = this.usuario_txt.getText().trim();
    String contrasena = String.valueOf(this.contrasena_txt.getPassword()).trim();
    ...
    if (camposValidos) {
        boolean acceso = loginControl.validarLogin(usuario, contrasena);

        if (acceso) {
            // 🔴 Aquí agregamos esta línea importante:
            Trabajador usuarioLogueado = new Trabajador();
            usuarioLogueado.setUsuario(usuario);
            usuarioLogueado.setContraseña(contrasena);
            codigos_jos.Sesion.usuarioLogueado = usuarioLogueado;

            Menu menu = new Menu();
            menu.setVisible(true);
            this.setVisible(false);
        } else {
            this.aviso_contrasena.setText("Usuario o contraseña incorrectos");
        }
    }
